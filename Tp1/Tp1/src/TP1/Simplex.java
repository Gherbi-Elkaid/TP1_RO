...
public class Simplex {
	ArrayList<String> nomVariableV = new ArrayList<>();//pour notations des variables verticale dans le tableau 
    ArrayList<String> nomVariableH = new ArrayList<>();//pour notations des variables horizontale dans le tableau
    ArrayList<Double> ArrayZ = new ArrayList<>();//les coef du fonction obectif

    int nbrVarBase = 0;//nbr des variables de base
    int nbrVarArtificial = 0;//nbr des variables artificials
    int nbrVarBaseNeg = 0;//nbr des variables de base negatif (dans le cas du superieur ou egale)
    int i = 0;
    int j = 0;
